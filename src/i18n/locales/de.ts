...
export const de: TranslationKeys = {
  ...
  // ── PDF Export Settings ─────────────────────────────────────────────────────
  pdfExport: {
    title: 'PDF-Export-Einstellungen',
    description: 'Anpassung des PDF-Abrechnungsaussehens',
    includeReleaseBreakdown: 'Release-Aufschlüsselung einbeziehen',
    includePlatformBreakdown: 'Plattform-Aufschlüsselung einbeziehen',
    includeCollaborators: 'Kollaborateure einbeziehen',
  ...
  // ── Payout Manager ──────────────────────────────────────────────────────────
  payout: {
    title: 'Auszahlungs-Manager',
    description: 'Künstler-Auszahlungsregeln und -Überschreibungen verwalten',
    guestPayouts: 'Gast-Auszahlungen',
    guestPercentage: 'Gast %',
    primaryArtist: 'Hauptkünstler',
    guestArtist: 'Gast-Künstler',
  },
