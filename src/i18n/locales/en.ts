...
export const en = {
  ...
  ignoredEntry: {
    ...
    artist: 'Artist',
    artistPlaceholder: 'Search artist…',
    noArtistFound: 'No matching artist',
    releaseTitle: 'Release Title (optional)',
    releasePlaceholder: 'Search release…',
    noReleaseFound: 'No matching release',
  ...
  trackRevenueAssignment: {
    ...
    trackTitlePlaceholder: 'Search release / track title…',
    ownerArtistPlaceholder: 'Search owner artist…',
    noArtistFound: 'No matching artist',
    noReleaseFound: 'No matching release',
